...
var Message = function (_Component) {
  ...
  Message.prototype._renderMessageOfType = function _renderMessageOfType(type) {
    switch (type) {
      case 'text':
        return _react2.default.createElement(_TextMessage2.default, { message: this.props.message, onDelete: this.props.onDelete });
      case 'emoji':
        return _react2.default.createElement(_EmojiMessage2.default, this.props.message);
      case 'file':
        return _react2.default.createElement(_FileMessage2.default, { onDelete: this.props.onDelete, message: this.props.message });
    }
  };
